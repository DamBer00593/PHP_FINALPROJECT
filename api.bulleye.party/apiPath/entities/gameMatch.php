...
class GameMatch implements JsonSerializable{
    ...
    private $teamID;
    /**
     * @var ranking contains the round
     */
    private $ranking
    /*
     ...
     * @param playerID|null
     */
    public function __construct($gameID, $matchID, $gameNumber, $gameStateID, $score, $balls, $playerID, $roundID, $matchGroup, $teamID, $ranking){
        if($gameID > 0){
            $this->gameID = $gameID;
        }else{
